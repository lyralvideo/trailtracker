...
if ('C:\Users\Asher\.vscode\trailtracker\trailtracker\backendexpress\mysql server\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\Asher\.vscode\trailtracker\trailtracker\backendexpress\mysql server\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
