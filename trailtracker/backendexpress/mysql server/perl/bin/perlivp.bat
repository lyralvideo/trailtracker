...
#!perl
#line 29
    eval 'exec C:\Users\Asher\.vscode\trailtracker\trailtracker\backendexpress\mysql server\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\Asher\.vscode\trailtracker\trailtracker\backendexpress\mysql server\perl\bin\perl.exe';
